...
$GLOBALS['TL_DCA']['tl_search4you_featured_items'] = array
(
	// Config
	'config' => array
	(
		...
		'ptable' => 'tl_search4you_featured_categories',
		'markAsCopy' => 'title',
		'sql' => array
		(
			'keys' => array
	...
	'palettes' => array
	(
		'default' => '{title_legend},title,text,suchtext,url,tags,css;{invisible_legend:hide},invisible'
	),
	...
	(
		...
		(
			'inputType' => 'cfgTags',
			'eval' => [
				'tagsManager' => 'search4you_featured_items_tags_manager',
				'tagsCreate' => true,
				'maxItems' => 5,
				'hideList' => true,
				'tl_class' => 'clr'
